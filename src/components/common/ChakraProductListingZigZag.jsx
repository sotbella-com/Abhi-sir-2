...
const ChakraProductListingZigZag = ({
  collectionPoduct,
  loading,
  isActive = true,
  sortBy,
        ...
        <Grid templateColumns="repeat(2, 1fr)">
          {Array.isArray(sortedProducts) &&
            ...
            sortedProducts.map((item, index) => {
              const isFull = (index + 1) % 3 === 0; // 3rd, 6th, 9th ... item full width
...
/* ---------- Replace your existing ChakraProductImage with this ---------- */
          ...
          {!isExchangeMode && !isHidden && (
            ...
            >
              ...
              >
                ...
                {/* 💻 Desktop hover panel (no group hover; only icon wrapper hover) */}
                {!isMobile && (
                  <Box
                    role="dialog"
                    id="add-to-cart"
                        ...
                        return (
                          <button
                            ...
                            onClick={async (e) => {
                              ...
                              // Optional: quick visual lock to prevent double taps
...
export default ChakraProductListingZigZag;
