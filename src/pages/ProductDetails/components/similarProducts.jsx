    ...
    (async () => {
      ...
      try {
        ...
        if (categorySlug) {
          ...
          effectiveCategoryId = (categorySlug) || categorySlug;
        }
        ...
        const response = await searchCategoryProducts(effectiveCategoryId, {
          ...
          offset: 0,
          siteId: null, // Will use dynamic site ID
          sort: sortBy || "",
        });
        ...
        <Box mt={{ base: 6, md: 14 }}>
          <Flex justify="space-between" align="center">
            ...
            {fromCollection?.slug && (
              <Button
                as={RouterLink}
                to={`/category/${fromCollection.slug}`}
                size="xs"
                variant="ghost"
                textTransform="uppercase"
                fontWeight="medium"
        ...
        {loading ? (
          ...
          >
            {sortedProducts.map((item) => {
              ...
              // 🔹 Currency from product (NO global fallback symbol)
              const currencyCode =
                item?.currency ||
                item?.currencyCode ||
                ...
                >
                  ...
                  >
                    {hasImage(item) ? (
                      ...
                      >
                        {/* ❤️ Wishlist toggle (remove -> refresh) */}
                        <IconButton
                          id="wishlist-btn"
                  ...
                  <VStack px={1} align="stretch" gap={0} mt={{ base: -1, md: 0 }}>
                    ...
                    <HStack justify="space-between" align="center">
                      ...
                      >
                        <IconButton
                          ...
                          icon={<Image src={scaleIcon} alt="Scale Icon" h="15px" w="auto" />}
                          size="sm"
                          variant="ghost"
                          onClick={(e) => {
                            e.stopPropagation();
                    ...
                    {/* Price row */}
                    <HStack justify="space-between" align="center" mt={{ base: -1, md: 0 }}>
                      <HStack>
                        <Text fontSize={{ base: "10px", md: "12px" }} fontWeight="normal" marginTop="-5px" id="product-price">
                          {currencyCode} {price}
                        </Text>
                        {hasDiscount && (
                          <Text fontSize={{ base: "10px", md: "12px" }} color="blackAlpha.500" as="del">
                            {currencyCode} {displayPrice}
                          </Text>
                        )}
                      </HStack>
                    </HStack>
  ...
  return (
    <Box position="relative" overflow="visible" h="full">
      ...
      <Box position="relative" w="full" h="full" overflow="hidden" role="group">
        ...
        {/* Wishlist slot */}
        <Box position="absolute" top={{ base: 0.5, md: 2 }} right={{ base: 0.5, md: 2 }} zIndex={10}>
          {children}
        </Box>
