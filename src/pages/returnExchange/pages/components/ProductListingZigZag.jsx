...
// ✅ CHANGE: remove close icon (only used in cart popup)
...
const ProductListingZigZag = ({
    ...
    // ✅ Same behavior as Grid: remove -> refresh
    const toggleWishlist = async (item) => {
        ...
        if (inWishlist(item.id)) {
            ...
            setTimeout(() => navigate(0), 300); // force page refresh so icons/state sync everywhere
        } else {
    ...
    // ✅ CHANGE: remove addProductToCart function completely
                    ...
                    <Grid templateColumns="repeat(2, 1fr)">
                        {Array.isArray(sortedProducts) &&
                            ...
                            sortedProducts.map((item, idx) => {
                                const isFull = (idx + 1) % 3 === 0; // 3rd, 6th, 9th ... item full width
                                            ...
                                            <HStack justify="space-between" align="center">
                                                ...
                                                >
                                                    <IconButton
                                                        ...
                                                        icon={
                                                            <Image src={scaleIcon} alt="Scale Icon" h="20px" w="auto" />
                                                        }
                                                        size="xs"
                                                        variant="ghost"
                                                        onClick={(e) => {
...
/* ---------- Exact same ChakraProductImage, but cart UI removed ---------- */
    ...
    return (
        <Box position="relative" overflow="visible" h="full">
            ...
            <Box position="relative" w="full" h="full" overflow="hidden" role="group">
                ...
                {/* ✅ CHANGE: cart icon + panel removed */}
            </Box>
        </Box>
    );
};

export default ProductListingZigZag;
