...
/* ---- Row component with optional TOP divider (md+) ---- */
const RowLink = ({ to, label, icon, withTopDivider }) => (
  <Box
    borderTop={{ base: "none", md: withTopDivider ? "1px solid" : "none" }}
  ...
  >
    ...
    >
      ...
      <Box display={{ base: "block", md: "none" }} color="blackAlpha.700">
        <ChevronRight />
      </Box>
    </ChakraLink>
  </Box>
...
const MobileAcount = () => {
  ...
  const { clearAddress, setAddress } = useAddressStore();
  ...
  const handleLogout = async () => {
    try {
      // Clear cart and address state
      clearBasket();
      setAddress([]);

      // Call main logout function (clears all localStorage)
      logout();
  ...
  return (
    <Fragment>
      ...
      <Box display={{ base: "none", md: "block" }} mt="90px" py={4}>
        <Text textAlign="center" fontSize="4xl" textTransform={"uppercase"} fontFamily="Dm Serif Display" fontWeight="normal">
          My Account
        </Text>
      </Box>

      {/* Content */}
      <Box pb={5} pt={14} px={{ base: "12px", md: "24px", xl: "75px" }}>
        {/* Mobile heading */}
        <Box display={{ md: "none" }} mb={2} mt={3}>
          <Text fontSize="sm" textTransform="uppercase" fontWeight="semibold" letterSpacing="0.12em" color="black">
            My Account
          </Text>
        </Box>

        {/* List container */}
        <Box mx="auto" w="full" maxW={{ md: "350px" }}>
          <RowLink to="/order" label="Order History" icon={<OrderIcon />} withTopDivider={false} />
          <RowLink to="/wallet" label="Wallet & Transactions" icon={<WalletIcon />} withTopDivider />
          <RowLink to="/coupons" label="Coupons" icon={<CouponIcon />} withTopDivider />
          <RowLink to="/customer-address" label="Addresses" icon={<LocationIcon />} withTopDivider />
          <RowLink to="/manage-profile" label="Account Details" icon={<ProfileIcon />} withTopDivider />

          {/* Divider BETWEEN Account Details and Logout/Login */}
          <Box borderTop={{ base: "none", md: "1px solid" }} borderColor="blackAlpha.300">
            {isAuthenticated ? (
              <Flex
                as="button"
              ...
              >
                <LogoutIcon />
                <Text>Logout</Text>
                <Box display={{ base: "block", md: "none" }} color="#FF0000" />
              </Flex>
            ) : (
              <ChakraLink
                as={RouterLink}
...
const ChevronRight = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    <path d="M9 5l7 7-7 7" stroke="#000" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
const OrderIcon = () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M12 22C11.1818 22 10.4002 21.6698 8.83693 21.0095C4.94564 19.3657 3 18.5438 3 17.1613C3 16.7742 3 10.0645 3 7M12 22C12.8182 22 13.5998 21.6698 15.1631 21.0095C19.0544 19.3657 21 18.5438 21 17.1613V7M12 22V11.3548" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  <path d="M8.32592 9.69138L5.40472 8.27785C3.80157 7.5021 3 7.11423 3 6.5C3 5.88577 3.80157 5.4979 5.40472 4.72215L8.32592 3.30862C10.1288 2.43621 11.0303 2 12 2C12.9697 2 13.8712 2.4362 15.6741 3.30862L18.5953 4.72215C20.1984 5.4979 21 5.88577 21 6.5C21 7.11423 20.1984 7.5021 18.5953 8.27785L15.6741 9.69138C13.8712 10.5638 12.9697 11 12 11C11.0303 11 10.1288 10.5638 8.32592 9.69138Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  <path d="M6 12L8 13" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  <path d="M17 4L7 9" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
</svg>);
const WalletIcon = () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M16 14C16 14.8284 16.6716 15.5 17.5 15.5C18.3284 15.5 19 14.8284 19 14C19 13.1716 18.3284 12.5 17.5 12.5C16.6716 12.5 16 13.1716 16 14Z" stroke="black" strokeWidth="1.5" />
  <path d="M10 7H16C18.8284 7 20.2426 7 21.1213 7.87868C22 8.75736 22 10.1716 22 13V15C22 17.8284 22 19.2426 21.1213 20.1213C20.2426 21 18.8284 21 16 21H10C6.22876 21 4.34315 21 3.17157 19.8284C2 18.6569 2 16.7712 2 13V11C2 7.22876 2 5.34315 3.17157 4.17157C4.34315 3 6.22876 3 10 3H14C14.93 3 15.395 3 15.7765 3.10222C16.8117 3.37962 17.6204 4.18827 17.8978 5.22354C18 5.60504 18 6.07003 18 7" stroke="black" strokeWidth="1.5" strokeLinecap="round" />
</svg>);
...
const LocationIcon = () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M13.6177 21.367C13.1841 21.773 12.6044 22 12.0011 22C11.3978 22 10.8182 21.773 10.3845 21.367C6.41302 17.626 1.09076 13.4469 3.68627 7.37966C5.08963 4.09916 8.45834 2 12.0011 2C15.5439 2 18.9126 4.09916 20.316 7.37966C22.9082 13.4393 17.599 17.6389 13.6177 21.367Z" stroke="black" strokeWidth="1.5" />
  <path d="M15.5 11C15.5 12.933 13.933 14.5 12 14.5C10.067 14.5 8.5 12.933 8.5 11C8.5 9.067 10.067 7.5 12 7.5C13.933 7.5 15.5 8.11929 15.5 9.5Z" stroke="black" strokeWidth="1.5" />
</svg>);
const ProfileIcon = () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  <path d="M7.5 17C9.8317 14.5578 14.1432 14.4428 16.5 17M14.4951 9.5C14.4951 10.8807 13.3742 12 11.9915 12C10.6089 12 9.48797 10.8807 9.48797 9.5C9.48797 8.11929 10.6089 7 11.9915 7C13.3742 7 14.4951 8.11929 14.4951 9.5Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" />
</svg>);
